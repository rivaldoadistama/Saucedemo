...
WebUI.click(findTestObject('Object Repository/Asset Login/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_0dff71'))

WebUI.verifyElementText(findTestObject('Asset Login/Page_Swag Labs/Username tidak valid'), 'Epic sadface: Username and password do not match any user in this service')
